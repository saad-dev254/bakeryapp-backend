...
function createApp() {
    ...
    app.use("/api", vendors_routes_1.vendorRouter, rider_routes_1.riderRouter, product_routes_1.productRouter, category_routes_1.categoryRouter, addOns_routes_1.addOnRouter, order_routes_1.orderRouter, userAddress_routes_1.addressRouter, shipment_routes_1.shipmentRouter, country_routes_1.countryRouter, delivery_routes_1.deliveryRouter, city_routes_1.cityRouter);
