...
function validateCityFields(body: any, type: "create" | "update" = "create") {
...
export const getAllCities = asyncHandler(async (req: Request, res: Response) => {
    try {
        const cities = await City.find().lean(); // Fetch all Cities from MongoDB
...
export const getSingleCity = asyncHandler(async (req: Request, res: Response) => {
    const { id } = req.params;
